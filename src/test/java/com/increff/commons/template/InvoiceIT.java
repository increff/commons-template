...
import com.increff.commons.template.form.ServiceLineItem;
...
public class InvoiceIT extends AbstractTest {
	...
	public static InvoiceForm form() {
		...
		form.setInvoiceCancelled(false);
...
*/
	...
	public static List<TaxRateLineItem> getTaxRates() {
		...
		TaxRateLineItem item1 = new TaxRateLineItem("CGST%", 1.123);
		TaxRateLineItem item2 = new TaxRateLineItem("SGST%", 2.123);
		TaxRateLineItem item3 = new TaxRateLineItem("IGST%", 3.123);
//		TaxRateLineItem item4 = new TaxRateLineItem("CESS%", 0.000, 0.0D, 0.0D);
		list.add(item1);
		list.add(item2);
		list.add(item3);
//		list.add(item4);
	...
	public static List<ServiceLineItem> getServiceLineItems() {
		...
		ServiceLineItem item1 = getServiceLineItem("Shipping charge", 30.123, 3, 33.123);
		ServiceLineItem item2 = getServiceLineItem("COD charge", 10.123, 1, 11.123);
